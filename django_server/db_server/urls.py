...
urlpatterns = [
    ...
    path(
        "msg/<str:device_id>/", TrackAndTraceDetailList.as_view(), name="retrieve-msg"
    ),
    path(
        "msg/update/<str:device_id>/", TrackAndTraceUpdate.as_view(), name="update-msg"
    ),
    path(
        "msg/delete/<str:device_id>/", TrackAndTraceDelete.as_view(), name="delete-msg"
    ),
]
